//Arreglo para guardar infinitas personas.
...
function crearPersonasCustom(){
    ...
    const years = prompt("Ingrese un edad: ");
    const gender = prompt("Ingrese un genero: ");
    const height = prompt("Ingrese una altura: ");

    const persona = new Person(name,years,gender,height);
